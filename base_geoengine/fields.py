...
class GeoField(Field):#GeoFiel=modulo para almacenar datos geograficos
    ...
    geo_type = None#geo_type=nombre correspondiente en el sistema Gis

    @property#property=permite trabajar con los atributos privados
    def column_format(self):#self=podemos acceder a los atributos y metodos de la clase
        return "ST_GeomFromText(%%s, %s)" % (self.srid,)#%s=marcador de posición para una cadena  %d=marcador de posición para un numero  #srid=Identificador de Referencia Espacial,define todos los parámetros del Sistema de Coordenadas y la proyección

    @property
    def column_type(self):
        return ('geometry', 'geometry')

    _slots = {#slots=acceso mas rapido a los atributos
        'dim': 2,#matriz
        'srid': 4326,
        'gist_index': True,
        'manual': True,
